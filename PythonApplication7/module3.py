...
def draw_skeletons(skeletons):
    ...
    for index, data in enumerate(skeletons):
                    if data.eTrackingState == nui.SkeletonTrackingState.TRACKED and not(isTracked):
                        ...
                        LastAction=0
                        if not(Flying):
                            if(shapR=='rdlu') and ActionPerforming['Just']==False:
                         ...
                         #++++++++++++++++++++++++++++++++++++++++++++++The Remote , Need to impliment based on Continues Gestures than stattic one++++++++++++++          
                            ...
                            if (shapR=='rdrd') and ActionPerforming['Just']==False :
                                drn.land()
                            ...
                            if (shapR=='ldld') and ActionPerforming['MoveForward']==False:
                                drn.move_forward()
                            ...
                            '''if (shapR=='ldld') and (pdemor=='lulu') and ActionPerforming['Hover']==False:
                                ...
                                resetflag('Hover')'''
                            if (shapR=='rdlu') and ActionPerforming['MoveBackward']==False:
                                 drn.move_backward()
